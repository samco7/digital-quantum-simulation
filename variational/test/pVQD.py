...
class pVQD:
    ...
    def construct_total_circuit(self,time_step,is_circuit):
    ...
    def construct_total_circuit_local(self,time_step,is_circuit):
    ...
    def run(
        ...
        if cost_fun == 'global':
            state_wfn = self.construct_total_circuit(timestep,is_circuit)
        elif cost_fun == 'local':
            state_wfn = self.construct_total_circuit_local(timestep,is_circuit)
